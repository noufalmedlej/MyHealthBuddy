...
public class ViewXRay extends AppCompatActivity {
                ...
                if(dataSnapshot.hasChild("file")){
                    ...
                    attachmentView.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            //pdfviewer
                            Intent redirect = new Intent(ViewXRay.this,ReadActivity.class);
    ...
    private void UserMenuSelector(MenuItem item) {
        switch (item.getItemId()){
            case R.id.nav_share:
                Intent intent = new Intent(ViewXRay.this, ViewRecordtoShare.class);
                startActivity(intent);
                break;

            case R.id.nav_request:
                Intent intentrequest=new Intent(ViewXRay.this, ViewRequests.class);
